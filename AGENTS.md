...
## Additional User Instructions (2026-04-05)
...
- If you can't fix a lint issue write it in `AGENT_NOTES.md`.
- Use semantic versioning and increase the version whenever you make changes.
  - `<major>.<minor>.<patch>`
  - Simple fixes increase patch.
  - Feature implementations increase minor.
  - Backward incompatible changes increase major.
  - If explicitly told to increase major after a new feature, increase major.
- Ensure these files exist: `AGENT_NOTES.md`, `BACKLOG.md`, `CHANGELOG.md`, `DESIGN.md`, `README.md`.
